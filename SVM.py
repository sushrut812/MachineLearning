# -*- coding: utf-8 -*-
"""
Created on Wed Mar 20 10:51:45 2019

@author: Admin
"""

#ired Python PackagesPython
# Required Packages
...
#visuvalizing the Petal vs Iris typePython
...
#Modelling different kernal SVm classification
iris = datasets.load_iris()
...
plt.show()
#Modelling Different Kernal SVM using iris Petal features
iris = datasets.load_iris()
X = iris.data[:, 2:]  # we only take the last two features.
y = iris.target
C = 1.0  # SVM regularization parameter
...
# SVC with polynomial (degree 3) kernel
poly_svc = svm.SVC(kernel='poly', degree=3, C=C).fit(X, y)
#visualizing modeled SVM Classifier with iris features 
